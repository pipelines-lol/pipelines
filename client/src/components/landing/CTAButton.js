    ...
    if (href) {
        return (
            <>
                <a
                    href={href}
                    className="group relative z-0 mt-6 inline-flex items-center justify-center overflow-hidden rounded-lg bg-pipelines-gray-100 px-10 py-2 font-mono font-medium tracking-tighter text-black/80"
                >
