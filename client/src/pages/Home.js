        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center w-full h-full bg-white gap-12">
                ...
                <div className="flex flex-col justify-center items-start text-center w-full h-[50vh] gap-8">
                    <h1 className="w-full text-pipelines-gray-500 font-bold text-3xl">Discover Your Pipeline</h1>
                    ...
                    <div className="flex flex-row justify-evenly w-full h-full 2xl:gap-24 gap-4">
                        ...
                        <div className="flex flex-col justify-center items-start w-1/2 h-full">
                            <p className="2xl:w-1/2 w-full text-pipelines-gray-500 font-light 2xl:leading-7 leading-2 2xl:text-lg lg:text-md text-xs">
                                A <span className="font-semibold">pipeline</span> is a roadmap of experiences that individuals traverse throughout their professional journey. 
                                It captures the diverse paths taken by individuals, starting from pivotal internships to noteworthy career milestones. 
                                
                                <br /><br /> 

                                Explore the journeys of others who, like you, began their professional adventure with (rotating company name), 
                                and uncover where their unique pipelines have led them. Gain insights, draw inspiration, and chart your course 
                                by discovering the diverse destinations that await along your own career pipeline.
                            </p>
                        </div>
                    </div>
                </div>

                <div className="flex flex-col justify-center items-center w-full h-[50vh] gap-8">
                    <div className="flex flex-col justify-center items-center w-full gap-5 py-12">
                    {
