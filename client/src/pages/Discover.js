    ...
    return (
        <div className="flex min-h-screen w-full flex-col items-center justify-center pt-20 text-center">
            <div className="flex w-full flex-col items-center justify-center pt-16">
                ...
                <div className="min-h-96 grid w-full grid-cols-1 overflow-y-scroll border-b-[0.5px] border-t-[0.5px] border-pipeline-blue-200 bg-pipelines-gray-100/10 bg-opacity-95  pb-12 sm:grid-cols-2 sm:gap-2 md:grid-cols-3 md:gap-4 lg:grid-cols-4">
