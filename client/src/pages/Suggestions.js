    ...
    return (
        <div className="flex justify-center items-center w-full h-[90vh] bg-gray-100">
            <div className="flex flex-col justify-center items-center w-96 h-2/3 bg-white shadow-md py-10 gap-10">
                <h1 className="text-black font-semibold text-2xl tracking-wide uppercase">Suggestions</h1>
                ...
                <div className="flex flex-col gap-3 w-full px-4">
                    ...
                    <select
                        ...
                        className="px-4 py-2 text-gray-800 bg-gray-100 rounded-full outline-none w-full" // Adjusted the class to match the input style
                    >
                    ...
                    <input className = "mt-10 mb-4 px-4 py-2 text-gray-800 bg-gray-100 rounded-full outline-none w-full"
