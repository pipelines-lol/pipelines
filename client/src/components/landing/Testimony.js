...
export default function Testimonies() {
    ...
    return (
        <>
            <section className="bg-black/35 flex h-full w-full flex-col items-center justify-center gap-4 border-b-[0.5px] border-pipeline-blue-200">
                    ...
                    <div className="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:gap-x-16 lg:space-y-0">
                        <blockquote className="sm:flex lg:block">
                            ...
                            <div className="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                                ...
                                <cite className="mt-4 block font-light not-italic text-pipeline-blue-200">
